...
placeholder="Title" value="{{ $proyect->title }}" required>
...
<img src="{{ asset('storage/images/'.$proyect->image) }}" class="img-
fluid img-thumbnail" width="150">

<div class="my-2">
<textarea name="content" id="content" rows="6" class="form-control"

placeholder="Post Content" required>{{ $proyect->content }}</textarea>
